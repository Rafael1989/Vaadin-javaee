package pt.confidentia.rafael.ui.views.storefront;
...
import pt.confidentia.rafael.ui.views.orderedit.OrderEditView;
...
public class StorefrontView extends StorefrontViewDesign implements View {
	 ...
	 * refreshes the browser as long as the view is set to {@link ViewScoped}.
	 * If we set the view to {@link UIScoped}, the instance will be kept in
	 * memory (in the session) as long as the UI exists in memory and the same
	 * view instance will be reused whenever the user enters the view.
	 * <p>
