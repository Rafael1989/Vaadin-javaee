package pt.confidentia.rafael.ui.components;
...
public class OrdersGrid extends Grid<Order> {
	...
	private static String getOrderSummary(Order order) {
		Stream<String> quantityAndName = order.getItemsStream()
	...
	private static String twoRowCell(String header, String content) {
		return "<div class=\"header\">" + StringEscapeUtils.escapeHtml4(header) + "</div><div class=\"content\">"
				+ StringEscapeUtils.escapeHtml4(content) + "</div>";
	}
