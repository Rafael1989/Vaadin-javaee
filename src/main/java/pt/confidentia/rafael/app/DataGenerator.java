package pt.confidentia.rafael.app;
...
import pt.confidentia.rafael.app.security.BcryptPasswordMatcher;
import pt.confidentia.rafael.backend.OrderRepository;
import pt.confidentia.rafael.backend.PickupLocationRepository;
import pt.confidentia.rafael.backend.ProductRepository;
import pt.confidentia.rafael.backend.UserRepository;
...
import pt.confidentia.rafael.backend.data.entity.Order;
import pt.confidentia.rafael.backend.data.entity.OrderItem;
...
public class DataGenerator implements HasLogger {
	...
	private void createAdminUser() {
		User user = new User("admin@vaadin.com", "Admin", passwordEncoder.encode("admin"), Role.ADMIN);
		user.setLocked(true);
