...
@ServerClass("pt.confidentia.rafael.ui.views.orderedit.OrderEditViewDesign")
@AutoGenerated
public class OrderEditViewDesignElement extends VerticalLayoutElement {
	...
	public OrderHistoryElement getHistory() {
		return $(pt.confidentia.rafael.ui.views.orderedit.OrderHistoryElement.class).id("history");
	}
